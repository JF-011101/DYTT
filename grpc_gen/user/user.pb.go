...
type DouyinUserQueryRequest struct {
	...
	QueryData *Matrix `protobuf:"bytes,1,opt,name=query_data,json=queryData,proto3" json:"query_data,omitempty"`
}
...
func (x *DouyinUserQueryRequest) GetQueryData() *Matrix {
	if x != nil {
		return x.QueryData
	}
	return nil
...
type DouyinUserQueryResponse struct {
	...
	StatusCode int32   `protobuf:"varint,1,opt,name=status_code,json=statusCode,proto3" json:"status_code,omitempty"` // 状态码，0-成功，其他值-失败
	Ans        *Matrix `protobuf:"bytes,2,opt,name=ans,proto3" json:"ans,omitempty"`
...
func (x *DouyinUserQueryResponse) GetAns() *Matrix {
	if x != nil {
		return x.Ans
	}
	return nil
...
type DouyinUserRefreshResponse struct {
	...
	Data       *Matrix `protobuf:"bytes,2,opt,name=data,proto3" json:"data,omitempty"` // “提示”
	ShareState *State  `protobuf:"bytes,3,opt,name=share_state,json=shareState,proto3" json:"share_state,omitempty"`
	DbInfo     *Dbinfo `protobuf:"bytes,4,opt,name=db_info,json=dbInfo,proto3" json:"db_info,omitempty"`
	Params     *Params `protobuf:"bytes,5,opt,name=params,proto3" json:"params,omitempty"`
	StatusMsg  *string `protobuf:"bytes,6,opt,name=status_msg,json=statusMsg,proto3,oneof" json:"status_msg,omitempty"` // 返回状态描述
}
...
func (x *DouyinUserRefreshResponse) GetShareState() *State {
	if x != nil {
		return x.ShareState
	}
	return nil
...
func (x *DouyinUserRefreshResponse) GetDbInfo() *Dbinfo {
	if x != nil {
		return x.DbInfo
	}
	return nil
...
func (x *DouyinUserRefreshResponse) GetParams() *Params {
	if x != nil {
		return x.Params
	}
	return nil
...
type Dbinfo struct {
	...
	RowLength uint64 `protobuf:"varint,2,opt,name=row_length,json=rowLength,proto3" json:"row_length,omitempty"`
	Packing   uint64 `protobuf:"varint,3,opt,name=packing,proto3" json:"packing,omitempty"`
	Ne        uint64 `protobuf:"varint,4,opt,name=ne,proto3" json:"ne,omitempty"`
	X         uint64 `protobuf:"varint,5,opt,name=x,proto3" json:"x,omitempty"`
	P         uint64 `protobuf:"varint,6,opt,name=p,proto3" json:"p,omitempty"`
	Logq      uint64 `protobuf:"varint,7,opt,name=logq,proto3" json:"logq,omitempty"`
	Basis     uint64 `protobuf:"varint,8,opt,name=basis,proto3" json:"basis,omitempty"`
	Squishing uint64 `protobuf:"varint,9,opt,name=squishing,proto3" json:"squishing,omitempty"`
	Cols      uint64 `protobuf:"varint,10,opt,name=cols,proto3" json:"cols,omitempty"`
}
...
func (x *Dbinfo) GetRowLength() uint64 {
	if x != nil {
		return x.RowLength
	}
	return 0
...
func (x *Dbinfo) GetPacking() uint64 {
	if x != nil {
		return x.Packing
	}
	return 0
...
func (x *Dbinfo) GetSquishing() uint64 {
	if x != nil {
		return x.Squishing
	}
	return 0
...
type Params struct {
	...
	N     uint64  `protobuf:"varint,1,opt,name=N,proto3" json:"N,omitempty"`          // LWE secret dimension
	Sigma float64 `protobuf:"fixed64,2,opt,name=Sigma,proto3" json:"Sigma,omitempty"` // LWE error distribution stddev
	L     uint64  `protobuf:"varint,3,opt,name=L,proto3" json:"L,omitempty"`          // DB height
	M     uint64  `protobuf:"varint,4,opt,name=M,proto3" json:"M,omitempty"`          // DB width
	Logq  uint64  `protobuf:"varint,5,opt,name=Logq,proto3" json:"Logq,omitempty"`    // (logarithm of) ciphertext modulus
	P     uint64  `protobuf:"varint,6,opt,name=P,proto3" json:"P,omitempty"`          // plaintext modulus
}
...
func (x *Params) GetSigma() float64 {
	if x != nil {
		return x.Sigma
	}
	return 0
...
var file_idl_user_proto_rawDesc = []byte{
	...
	,
	...
	0x6d, 0x73, 0x67, 0x22, 0x50, 0x0a, 0x1b, 0x64, 0x6f, 0x75, 0x79, 0x69, 0x6e, 0x5f, 0x75, 0x73,
	0x65, 0x72, 0x5f, 0x72, 0x65, 0x66, 0x72, 0x65, 0x73, 0x68, 0x5f, 0x72, 0x65, 0x71, 0x75, 0x65,
	0x73, 0x74, 0x12, 0x22, 0x0a, 0x0a, 0x6f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x6d, 0x73, 0x67,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x48, 0x00, 0x52, 0x09, 0x6f, 0x70, 0x74, 0x69, 0x6f, 0x6e,
	0x4d, 0x73, 0x67, 0x88, 0x01, 0x01, 0x42, 0x0d, 0x0a, 0x0b, 0x5f, 0x6f, 0x70, 0x74, 0x69, 0x6f,
	0x6e, 0x5f, 0x6d, 0x73, 0x67, 0x22, 0x8f, 0x02, 0x0a, 0x1c, 0x64, 0x6f, 0x75, 0x79, 0x69, 0x6e,
	0x5f, 0x75, 0x73, 0x65, 0x72, 0x5f, 0x72, 0x65, 0x66, 0x72, 0x65, 0x73, 0x68, 0x5f, 0x72, 0x65,
	...
	,
	...
	0x77, 0x65, 0x72, 0x5f, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x22, 0x44, 0x0a, 0x06, 0x4d, 0x61, 0x74,
	0x72, 0x69, 0x78, 0x12, 0x12, 0x0a, 0x04, 0x72, 0x6f, 0x77, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x04, 0x52, 0x04, 0x72, 0x6f, 0x77, 0x73, 0x12, 0x12, 0x0a, 0x04, 0x63, 0x6f, 0x6c, 0x73, 0x18,
	0x02, 0x20, 0x01, 0x28, 0x04, 0x52, 0x04, 0x63, 0x6f, 0x6c, 0x73, 0x12, 0x12, 0x0a, 0x04, 0x64,
	0x61, 0x74, 0x61, 0x18, 0x03, 0x20, 0x03, 0x28, 0x04, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x22,
	0x43, 0x0a, 0x05, 0x53, 0x74, 0x61, 0x74, 0x65, 0x12, 0x12, 0x0a, 0x04, 0x72, 0x6f, 0x77, 0x73,
	...
	,
	...
	0x65, 0x72, 0x5f, 0x72, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x52, 0x0a,
	...
	0x00, 0x12, 0x46, 0x0a, 0x0b, 0x47, 0x65, 0x74, 0x55, 0x73, 0x65, 0x72, 0x42, 0x79, 0x49, 0x64,
	...
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x50, 0x0a, 0x09, 0x51, 0x75, 0x65,
	0x72, 0x79, 0x55, 0x73, 0x65, 0x72, 0x12, 0x1f, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x64, 0x6f,
	...
	,
...
var file_idl_user_proto_goTypes = []interface{}{
	...
	(*State)(nil),                      // 10: user.State
	(*Dbinfo)(nil),                     // 11: user.Dbinfo
	(*Params)(nil),                     // 12: user.Params
}
var file_idl_user_proto_depIdxs = []int32{
	8,  // 0: user.douyin_user_response.user:type_name -> user.User
	9,  // 1: user.douyin_user_query_request.query_data:type_name -> user.Matrix
	9,  // 2: user.douyin_user_query_response.ans:type_name -> user.Matrix
	9,  // 3: user.douyin_user_refresh_response.data:type_name -> user.Matrix
	10, // 4: user.douyin_user_refresh_response.share_state:type_name -> user.State
	11, // 5: user.douyin_user_refresh_response.db_info:type_name -> user.Dbinfo
	12, // 6: user.douyin_user_refresh_response.params:type_name -> user.Params
	0,  // 7: user.UserSrv.Register:input_type -> user.douyin_user_register_request
	0,  // 8: user.UserSrv.Login:input_type -> user.douyin_user_register_request
	2,  // 9: user.UserSrv.GetUserById:input_type -> user.douyin_user_request
	4,  // 10: user.UserSrv.QueryUser:input_type -> user.douyin_user_query_request
	6,  // 11: user.UserSrv.Refresh:input_type -> user.douyin_user_refresh_request
	1,  // 12: user.UserSrv.Register:output_type -> user.douyin_user_register_response
	1,  // 13: user.UserSrv.Login:output_type -> user.douyin_user_register_response
	3,  // 14: user.UserSrv.GetUserById:output_type -> user.douyin_user_response
	5,  // 15: user.UserSrv.QueryUser:output_type -> user.douyin_user_query_response
	7,  // 16: user.UserSrv.Refresh:output_type -> user.douyin_user_refresh_response
